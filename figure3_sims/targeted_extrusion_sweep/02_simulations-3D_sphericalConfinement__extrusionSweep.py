...
def initiate_sim(polymer, r, cell_size, chains, GPU, ixn_mtx, reporter):
...
with open('/net/levsha/share/emily/notebooks/sims/bombyx/toy_models/polymer_info_extrusion.pkl', 'rb') as f:
    polymer_params = pickle.load(f)
    
comp_ids = polymer_params['compartment_ID']
