...
base_path = '/net/levsha/share/emily/notebooks/sims/bombyx/toy_models/extrusion_and_compartments'
block_eq = 30_000
cutoff_rad = 5 
...
with open(f'/net/levsha/share/emily/notebooks/sims/bombyx/toy_models/polymer_info.pkl', 'rb') as f:
...
for d_X in dX_list:
    ...
    sim_dir_path = f'{base_path}/extrusion_density_sims/{d_dir}/{comp_dir}/{sim_dir}'
